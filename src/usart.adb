...
F:G$UsartAutoBaud$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$UsartSetBaudrate$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$UsartPutcharBlocking$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$UsartGetcharBlocking$0$0({2}DF,SC:S),Z,0,0,0,0,0
F:G$putchar$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$getchar$0$0({2}DF,SC:S),Z,0,0,0,0,0
F:G$SetPutcharFnc$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$SetGetcharFnc$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$ngets$0$0({2}DF,DG,SC:S),Z,0,0,0,0,0
S:G$MyPutchar$0$0({2}DC,DF,SV:S),E,0,0
S:G$MyGetchar$0$0({2}DC,DF,SC:S),E,0,0
S:LUsartAutoBaud$u16Timerwert$1$1({2}SI:U),R,0,0,[]
S:LUsartAutoBaud$u16Reloadwert$1$1({2}SI:U),R,0,0,[r2,r3]
S:LUsartSetBaudrate$u32Baudrate$1$1({4}SL:U),E,0,0
S:LUsartSetBaudrate$u32Reload$1$1({4}SL:U),R,0,0,[r4,r5,r6,r7]
S:LUsartSetBaudrate$u8CKCON$1$1({1}SC:U),E,0,0
S:LUsartSetBaudrate$u8PCON$1$1({1}SC:U),E,0,0
S:Lputchar$c$1$1({1}SC:S),R,0,0,[]
S:Lngets$s$1$1({3}DG,SC:S),E,0,0
S:Lngets$u8Size$1$1({1}SC:U),R,0,0,[r2]
S:Lngets$c$1$1({1}SC:U),R,0,0,[r4]
S:Lngets$u8Cntr$1$1({1}SC:U),R,0,0,[r3]
