M:pca
F:G$PcaInit$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$PcaInitModul$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$PcaGetMode$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$PcaSetPwm$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$PcaSetPwm$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$PcaSetPwm$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$PcaSetPwm$0$0({2}DF,SI:S),Z,0,0,0,0,0
S:G$ePcaClkSource$0$0({1}SC:U),E,0,0
S:G$ePcaModePca0$0$0({1}SC:U),E,0,0
S:G$ePcaModePca1$0$0({1}SC:U),E,0,0
S:LPcaSetPwm$u8PwmWert$1$1({1}SC:U),E,0,0
S:LPcaSetPwm$ePcaModul$1$1({1}SC:U),R,0,0,[r2]
