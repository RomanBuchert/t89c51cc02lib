M:isrvectors
F:G$IsrInit$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$IsrExt0$0$0({2}DF,SV:S),Z,0,0,1,0,0
F:G$IsrTmr0$0$0({2}DF,SV:S),Z,0,0,1,1,0
F:G$IsrExt1$0$0({2}DF,SV:S),Z,0,0,1,2,0
F:G$IsrTmr1$0$0({2}DF,SV:S),Z,0,0,1,3,0
F:G$IsrUart$0$0({2}DF,SV:S),Z,0,0,1,4,0
F:G$IsrTmr2$0$0({2}DF,SV:S),Z,0,0,1,5,0
F:G$IsrPca$0$0({2}DF,SV:S),Z,0,0,1,6,0
F:G$IsrCan$0$0({2}DF,SV:S),Z,0,0,1,7,0
F:G$IsrAdc$0$0({2}DF,SV:S),Z,0,0,1,8,0
F:G$IsrCanTmr$0$0({2}DF,SV:S),Z,0,0,1,9,0
F:G$IsrCanTmr$0$0({2}DF,SV:S),Z,0,0,1,9,0
F:G$IsrCanTmr$0$0({2}DF,SV:S),Z,0,0,1,9,0
F:G$IsrCanTmr$0$0({2}DF,SV:S),Z,0,0,1,9,0
F:G$IsrCanTmr$0$0({2}DF,SV:S),Z,0,0,1,9,0
